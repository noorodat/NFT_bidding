...
//       .then((response) => {
//         const userWonProducts = response.data.filter((product) => product.winner_id === userId);
//         setWonProducts(userWonProducts);
//       })
//       .catch((error) => {
...
//           <div key={product.id} className="col-5 col-lg-4 col-md-6 col-sm-6 col-12">
...
//                 <div className="profile-share">{/* Author avatars and more */}</div>
//                 <div className="share-btn share-btn-activation dropdown">{/* Share and report buttons */}</div>
//               </div>
//               <a href="product-details.html">
...
// export default UserWonProducts;
